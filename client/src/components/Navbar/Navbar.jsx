  ...
  return (
    <div className="">
      ...
      <nav
        ...
        `}
      >
        <div className="container mx-auto flex max-w-8xl items-center justify-between px-6 h-24"> {/* Added fixed height for smoother transition */}
          {/* Logo Section */}
